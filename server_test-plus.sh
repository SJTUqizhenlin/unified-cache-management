  ...
  UCM_ARGS=(
    ...
    '{
      ...
      "kv_connector_extra_config": {
        "UCM_CONFIG_FILE": "/workspace-genet/devA2/unified-cache-management/examples/ucm_config_example-plus.yaml"
      }
    }'
  )
fi
...
vllm serve /mnt/model/DeepSeek-V2-Lite-Chat \
  ...
  --block_size 128 --trust-remote-code --port 7880 --enforce-eager \
