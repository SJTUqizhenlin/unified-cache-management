...
curl http://localhost:7880/v1/completions \
...
python3 ./trace_replay.py --model /mnt/model/DeepSeek-V2-Lite-Chat --backend vllm \
  ...
  --trace-mode trace --host 127.0.0.1 --port 7880 --max-concurrency 20 --save-result --result-dir ./results/run_01 --save-prompts
